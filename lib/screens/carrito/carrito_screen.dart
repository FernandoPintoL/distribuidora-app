                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _CarritoItemCard(
                      ...
                      onIncrement: () {
                        ...
                        _mostrarErrorSiExiste(context, carritoProvider, duracion: 3);
                      },
                      onDecrement: () {
      ...
      bottomNavigationBar: Consumer<CarritoProvider>(
        builder: (context, carritoProvider, _) {
          ...
          return CarritoActionButtons(
            ...
            onContinuarCompra: () => _continuarCompra(context),
...
class _CarritoItemCard extends StatefulWidget {
  ...
  @override
  State<_CarritoItemCard> createState() => _CarritoItemCardState();
}

class _CarritoItemCardState extends State<_CarritoItemCard> {
