...
class _VentasAsignadasCardState extends State<_VentasAsignadasCard> {
                        ...
                        Row(
                          children: [
                            ...
                            if (venta.clienteTelefono != null &&
                              ...
                              const SizedBox(width: 4),
                              // ✅ NUEVO: Botón de descarga de PDF para la venta
                              SizedBox(
                                width: 32,
                                height: 32,
                                child: IconButton(
  ...
  // ✅ NUEVO: Método para descargar PDF de una venta
  Future<void> _descargarPDFVenta(int ventaId) async {
    try {
      ...
      final success = await printService.downloadDocument(
        ...
        format: PrintFormat.ticket58,  // ✅ TICKET_58 como en web
      );
...
// ✅ NUEVO: Widget para mostrar lista genérica de productos consolidados
class _ProductosGenericosCard extends StatefulWidget {
  final List<Map<String, dynamic>> productos;
  final int entregaId;

  const _ProductosGenericosCard({
    Key? key,
  ...
  @override
  State<_ProductosGenericosCard> createState() => _ProductosGenericosCardState();
}

class _ProductosGenericosCardState extends State<_ProductosGenericosCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      elevation: 2,
      child: ExpansionTile(
        initiallyExpanded: true,  // ✅ NUEVO: Card inicia abierto
        title: Row(
          children: [
            Icon(
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    '${widget.productos.length} artículos',
                    style: TextStyle(
                      fontSize: 12,
                      color: isDarkMode ? Colors.grey[400] : Colors.grey[600],
                    ),
            ...
            // ✅ NUEVO: Botón de descarga de ticket 58mm
            Padding(
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        children: [
                          ...
                          const Spacer(),
                          Text(
                            '${productosVenta.length} artículos',
                            style: TextStyle(
                              fontSize: 12,
                              color: isDarkMode
                                  ? Colors.grey[400]
                    ...
                    ...productosVenta.asMap().entries.map((pEntry) {
                      ...
                      // ✅ CORREGIDO: Parsing defensivo para valores numéricos (pueden llegar como String o num)
                      final cantidad = double.tryParse(
                            (p['cantidad'] is num ? p['cantidad'] : p['cantidad'])
                                .toString()) ??
                        0;
                      ...
                      final subtotal = double.tryParse(
                            (p['subtotal'] is num ? p['subtotal'] : p['subtotal'])
                                .toString()) ??
                        0;
