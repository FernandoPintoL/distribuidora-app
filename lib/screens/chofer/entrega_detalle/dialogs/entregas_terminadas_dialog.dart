...
class EntregasTerminadasDialog {
  static Future<void> show(
    ...
    final resultado = await showDialog<bool>(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Confirmar Entregas Terminadas'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            const Icon(Icons.check_circle, size: 48, color: Colors.green),
            const SizedBox(height: 16),
            const Text('¿Confirmas que todas las entregas fueron completadas?'),
    ...
    if (resultado == true && context.mounted) {
      ...
      try {
        debugPrint('✅ Finalizando entrega #${entrega.id}...');

        final success = await provider.finalizarEntrega(
          entrega.id,
          onSuccess: (mensaje) {
            debugPrint('✅ Entrega finalizada: $mensaje');
          },
          onError: (error) {
