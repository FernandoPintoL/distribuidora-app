...
/// ✅ Widget Stateless para sugerencia inteligente de pago
/// Muestra el saldo pendiente y sugiere aplicar el monto automáticamente
class SugerenciaPagoWidget extends StatelessWidget {
  final Map<String, dynamic>? sugerencia;
  final bool isDarkMode;
  final VoidCallback onAplicarSugerencia;
  ...
  const SugerenciaPagoWidget({
    ...
    required this.onAplicarSugerencia,
